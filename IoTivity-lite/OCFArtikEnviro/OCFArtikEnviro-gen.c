...
/*
 ...
 input_file            : /root/workspace/envirophatlite/device_output/out_codegeneration_merged.swagger.json
...
int init;
  ...
  PRINT("file : /root/workspace/envirophatlite/device_output/out_codegeneration_merged.swagger.json\n");
